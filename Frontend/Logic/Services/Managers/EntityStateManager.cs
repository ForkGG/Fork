...
using ForkFrontend.Logic.Services.Notifications.NotificationHandlers.EntityNotificationHandlers.PlayerNotificationHandlers;
...
public class EntityStateManager
{
    ...
    private void RegisterHandlers()
    {
        ...
        _notificationService.Register<EntityPerformanceNotification>(EntityPerformanceNotificationHandler.HandleNotification);
        _notificationService.Register<EntityStatusChangedNotification>(EntityStatusChangedNotificationHandler.HandleNotification);
        if (Entity is Server)
        {
            _notificationService.Register<UpdateBanlistPlayerNotification>(UpdateBanlistPlayerNotificationHandler.HandleNotification);
            _notificationService.Register<UpdatePlayerNotification>(UpdatePlayerNotificationHandler.HandleNotification);
            _notificationService.Register<UpdateWhitelistPlayerNotification>(UpdateWhitelistPlayerNotificationHandler.HandleNotification);
        }
    }
}